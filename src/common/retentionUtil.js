...
import { getMonthNumber, getCurrentMonthNumber, getCurrentWeekNumber, getWeekNumber } from './timeUtil'
import {
  updateStore,
  getEventsStore,
  getRetentionSDKData,
...
const getHighestTimestamp = (array) => {
...
const getTobeLogDate = (timestamp) => {
  let eventKey = ''
  let eventStamp = 0
...
const getSessionAvgObject = (code, date, averageTime) => {
  return {
    sentToServer: false,
    tstmp: date,
    logtstmp: Date.now(),
